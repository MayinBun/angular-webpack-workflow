export default function paginationDirective () {
    ...
    */
    function addPrevNext(scope, pageCount, mode){
        ...
        if(mode === 'prev') {
            ...
            alpha = { value : "<", title: 'Previous Page', page: prevPage };
    ...
    * @param {Object} scope - The local directive scope object
    */
    function addDots(scope,prev) {
        scope.List.push({
            value: scope.dots,    
     /**
     * Click action for dots (If removed, it will display as plain text)
     */
            action: function () {
                internalAction(scope,prev);
            }
        });
    }
    ...
    */ 
    function build(scope, attrs) {
        ...
        var fullAdjacentSize = (scope.adjacent * 2) + 1;
